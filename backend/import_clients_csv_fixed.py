...
if __name__ == "__main__":
    ...
    print(f"Clients imported: {result['created']} created, {result['updated']} updated, {result['skipped']} skipped")
    print(f"Classes created: {result['classes_created']}, Plans created: {result['plans_created']}")
    
    print("\n=== Importing Pending Invoices ===")
    invoices_result = import_pending_invoices(csv_file)
    print(f"Invoices created: {invoices_result['created']}, Missing clients: {invoices_result['missing_clients']}, Skipped: {invoices_result['skipped']}")
    print("\n=== Import Complete ===")
